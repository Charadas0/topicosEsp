...
var exServicoWhats = document.getElementById('exServicoWhats');
if (exServicoWhats) {
	exServicoWhats.addEventListener('mouseenter', (e) => {
		shake(e.currentTarget);
	});
}

document.querySelector('exServicos').addEventListener('mouseenter', (e) => {
  shake(e.currentTarget);
});

document.querySelector('.instrucoes').addEventListener('mouseenter', (e) => {
...
function shakeme (event13124) {
    shake(event13124.target);
}
/*
window.onload = function(){  
   document.getElementById('exServicoWhats').addEventListener("click", shakeme , false);//document.getElementById("ThisWillBeNull").innerHTML = "Why is this null?";  
}*/